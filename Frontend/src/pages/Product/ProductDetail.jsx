...
import { FaShoppingCart, FaBolt, FaShieldAlt,FaCheckCircle, FaTruck, FaLock } from "react-icons/fa";
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 lg:p-12 border-l border-gray-50">
              ...
              <div className="h-px bg-gray-500 my-8" />
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 border-2 border-slate-900 text-slate-900 px-8 py-4 rounded-2xl font-bold hover:bg-slate-50 transition-all active:scale-95"
                >
                  <FaShoppingCart /> Add to Cart
                </button>
                <button
                  onClick={() => buyNow(product)}
                  className="flex-1 flex items-center justify-center gap-2 bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-600 transition-all shadow-xl shadow-slate-200 active:scale-95"
                >
